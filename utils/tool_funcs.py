...
nvmlInit()  # need initialization here
...
def truncated_rand(mu = 0, sigma = 0.5, factor = None, bound_lo = None, bound_hi = None):
    if bound_lo is None:
        bound_lo = Config.truncated_rand_bound_lo
    if bound_hi is None:
        bound_hi = Config.truncated_rand_bound_hi
    while True:
